...
describe('REST API', function() {
  ...
  before(function() {
    twitty = new Twitty(config1);
  });

  it('GET `account/verify_credentials`', function(done) {
    twitty.get('account/verify_credentials', function(err, reply, response) {
  ...
  it('GET `account/verify_credentials` using promise API AND callback API', function(done) {
    ...
    var get = twitty.get('account/verify_credentials', function(err, data, resp) {
      assert(!err, err);
  ...
  it('POST `account/update_profile`', function(done) {
    twitty.post('account/update_profile', function(err, reply, response) {
      checkReply(err, reply);
  ...
  it('POST `statuses/update` and POST `statuses/destroy:id`', function(done) {
    ...
    var params = {
      status: '@tolga_tezel tweeting using github.com/ttezel/twitty. ' + helpers.generateRandomString(7)
    };
    twitty.post('statuses/update', params, function(err, reply, response) {
      checkReply(err, reply);
      console.log('\ntweeted:', reply.text);
  ...
  it('POST `statuses/update` with characters requiring escaping', function(done) {
    ...
    twitty.post('statuses/update', params, function(err, reply, response) {
      ...
      var text = reply.text;
      assert(reply.id_str);
      twitty.post('statuses/destroy/:id', { id: reply.id_str }, function(err, reply, response) {
        checkReply(err, reply);
        checkTweet(reply);
  ...
  it('POST `statuses/update` with \'Hi!!\' works', function(done) {
    ...
    twitty.post('statuses/update', params, function(err, reply, response) {
      ...
      twitty.post(destroyRoute, function(err, reply, response) {
        checkReply(err, reply);
        checkTweet(reply);
        assert.equal(reply.text, text);
        checkResponse(response);
  ...
  it('GET `statuses/home_timeline`', function(done) {
    twitty.get('statuses/home_timeline', function(err, reply, response) {
      checkReply(err, reply);
      checkTweet(reply[0]);
      checkResponse(response);
      done();
  ...
  it('GET `statuses/mentions_timeline`', function(done) {
    twitty.get('statuses/mentions_timeline', function(err, reply, response) {
      checkReply(err, reply);
      checkTweet(reply[0]);
      done();
    });
  ...
  it('GET `statuses/user_timeline`', function(done) {
    ...
    twitty.get('statuses/user_timeline', params, function(err, reply, response) {
      checkReply(err, reply);
      checkTweet(reply[0]);
      checkResponse(response);
      done();
  ...
  it('GET `search/tweets` with count set to 100', function(done) {
    ...
    twitty.get('search/tweets', params, function(err, reply, res) {
      checkReply(err, reply);
  ...
  it('GET `search/tweets` with geocode', function(done) {
    ...
    twitty.get('search/tweets', params, function(err, reply) {
      checkReply(err, reply);
      done();
    });
  });
  ...
  it('GET `direct_messages`', function(done) {
    twitty.get('direct_messages', function(err, reply, response) {
      checkResponse(response);
      checkReply(err, reply);
  ...
  it('GET `followers/ids`', function(done) {
    twitty.get('followers/ids', function(err, reply, response) {
      checkReply(err, reply);
  ...
  it('GET `followers/ids` of screen_name tolga_tezel', function(done) {
    twitty.get('followers/ids', { screen_name: 'tolga_tezel' }, function(err, reply, response) {
      checkReply(err, reply);
      assert.ok(Array.isArray(reply.ids));
      checkResponse(response);
      done();
  ...
  it('POST `statuses/retweet`', function(done) {
    ...
    twitty.get('search/tweets', { q: 'apple' }, function(err, reply, response) {
      checkReply(err, reply);
      assert.ok(reply.statuses);
      ...
      twitty.post('statuses/retweet/' + tweetId, function(err, reply, response) {
        checkReply(err, reply);
        var retweetId = reply.id_str;
        assert(retweetId);
        twitty.post('statuses/destroy/' + retweetId, function(err, reply, response) {
          checkReply(err, reply);
          done();
        });
      });
  ...
  it('POST `statuses/retweet/:id` without `id` in params returns error', function(done) {
    twitty.post('statuses/retweet/:id', function(err, reply, response) {
      assert(err);
  ...
  it('POST `statuses/retweet/:id`', function(done) {
    // search for a tweet to retweet
    twitty.get('search/tweets', { q: 'banana' }, function(err, reply, response) {
      checkReply(err, reply);
      assert.ok(reply.statuses);
      var tweet = reply.statuses[0];
      checkTweet(tweet);
      ...
      twitty.post('statuses/retweet/:id', { id: tweetId }, function(err, reply) {
        checkReply(err, reply);
        var retweetId = reply.id_str;
        assert(retweetId);
        twitty.post('statuses/destroy/:id', { id: retweetId }, function(err, reply, response) {
          checkReply(err, reply);
          done();
        });
      });
  ...
  it.skip('GET `users/suggestions/:slug`', function(done) {
    twitty.get('users/suggestions/:slug', { slug: 'funny' }, function(err, reply, res) {
      checkReply(err, reply);
  ...
  it.skip('GET `users/suggestions/:slug/members`', function(done) {
    twitty.get('users/suggestions/:slug/members', { slug: 'funny' }, function(err, reply, res) {
      checkReply(err, reply);
  ...
  it('GET `geo/id/:place_id`', function(done) {
    ...
    twitty.get('geo/id/:place_id', { place_id: placeId }, function(err, reply, res) {
      checkReply(err, reply);
  ...
  it('POST `direct_messages/new`', function(done) {
    ...
    async.series({
      postDm: function(next) {
        ...
        twitty.post('direct_messages/new', dmParams, function(err, reply) {
          assert(!err, err);
          assert(reply);
          dmId = reply.id_str;
      ...
      deleteDm: function(next) {
        twitty.post('direct_messages/destroy', { id: dmId }, function(err, reply) {
          assert(!err, err);
          exports.checkDm(reply);
  ...
  describe('Media Upload', function() {
    ...
    it('POST media/upload with png', function(done) {
      ...
      twitty.post('media/upload', { media_data: b64content }, function(err, data, response) {
    ...
    it('POST media/upload with animated GIF using `media_data` parameter', function(done) {
      ...
      twitty.post('media/upload', { media_data: b64content }, function(err, data, response) {
        assert(!err, err);
        exports.checkMediaUpload(data);
        var expectedImageTypes = ['image/gif', 'image/animatedgif'];
        var imageType = data.image.image_type;
        assert.ok(expectedImageTypes.indexOf(imageType) !== -1, 'got unexpected image type:' + imageType);
        done();
      });
    });
    ...
    it('POST media/upload with animated GIF, then POST a tweet referencing the media', function(done) {
      ...
      twitty.post('media/upload', { media_data: b64content }, function(err, data, response) {
        ...
        twitty.post('statuses/update', params, function(err, data, response) {
          assert(!err, err);
    ...
    it('POST media/upload with animated GIF using `media` parameter', function(done) {
      ...
      twitty.post('media/upload', { media: b64Content }, function(err, data, response) {
        assert(!err, err);
        exports.checkMediaUpload(data);
        var expectedImageTypes = ['image/gif', 'image/animatedgif'];
        var imageType = data.image.image_type;
    ...
    it('POST media/upload with JPG, then POST media/metadata/create with alt text', function(done) {
      ...
      twitty.post('media/upload', { media_data: b64content }, function(err, data, response) {
        ...
        twitty.post('media/metadata/create', params, function(err, data, response) {
          assert(!err, err);
  ...
  it('POST account/update_profile_image', function(done) {
    ...
    twitty.post('account/update_profile_image', { image: b64content }, function(err, data, response) {
      assert(!err, err);
  ...
  it('POST friendships/create', function(done) {
    ...
    twitty.post('friendships/create', params, function(err, data, resp) {
      assert(!err, err);
      exports.checkReply(err, data);
      exports.checkUser(data);
      done();
  ...
  describe('Favorites', function() {
    it('POST favorites/create and POST favorites/destroy work', function(done) {
      twitty.post('favorites/create', { id: '583531943624597504' }, function(err, data, resp) {
        assert(!err, err);
        exports.checkReply(err, data);
        var tweetIdStr = data.id_str;
        assert(tweetIdStr);

        twitty.post('favorites/destroy', { id: tweetIdStr }, function(err, data, resp) {
          assert(!err, err);
          exports.checkReply(err, data);
          assert(data.id_str);
          assert(data.text);
  ...
  describe('error handling', function() {
    describe('handling errors from the twitter api', function() {
      ...
      it('should callback with an Error object with all the info and a response object', function(done) {
        twitty.get('account/verify_credentials', function(err, reply, res) {
    ...
    it('should return a rejected promise with the Twitter API errors', function() {
      twitty.get('account/verify_credentials')
        .then(result => {
...
exports.req_with_retries = function(twittyInstance, numTries, verb, path, params, statusCodesToRetry, cb) {
  twittyInstance[verb](path, params, function(err, data, response) {
    if (!numTries || (statusCodesToRetry.indexOf(response.statusCode) === -1)) {
      return cb(err, data, response);
    }

    exports.req_with_retries(twittyInstance, numTries - 1, verb, path, params, statusCodesToRetry, cb);
  });
};